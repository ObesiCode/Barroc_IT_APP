...
class salescontroller extends Controller
{
    ...
    public function store(Request $request)
    {
            ...
            $this->validate($request,[
                ...
                'phonenumber' => 'required|numeric|phone_number|size:10|min:0',
                'fax' => 'required|numeric|phone_number|size:10|min:0',
                'banknm' => 'required|numeric|min:0',
                'balance' => 'required|string|min:0|max:10',
                'doac' => 'required|date',
